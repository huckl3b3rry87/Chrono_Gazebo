...
private: ros::NodeHandle* rosnode_;
    ...
    std::shared_ptr<vehicle::WheeledVehicle> veh;
    std::shared_ptr<vehicle::RigidTerrain> terrain;
    std::shared_ptr<vehicle::SimplePowertrain> powertrain;
    std::vector<std::shared_ptr<vehicle::RigidTire> > tires;
