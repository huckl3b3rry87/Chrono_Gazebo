...
class Follower0:
  def __init__(self):
      ...
      self.image_sub = rospy.Subscriber('vehicle0/driverCam0/image_raw', Image, self.image_callback)

      self.pub = rospy.Publisher('track_point0', Float64, queue_size=10)
